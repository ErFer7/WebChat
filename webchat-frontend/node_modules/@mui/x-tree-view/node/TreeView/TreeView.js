...
const TreeView = /*#__PURE__*/React.forwardRef(function TreeView(inProps, ref) {
  ...
  const props = (0, _extends2.default)({}, themeProps, {
  ...
  const treeId = (0, _useId.default)(idProp);
  const treeRef = React.useRef(null);
  const handleRef = (0, _useForkRef.default)(treeRef, ref);
  ...
  const [selected, setSelectedState] = (0, _useControlled.default)({
